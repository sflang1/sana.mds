""" Deprecated. Data models for Sana Mobile Dispatch Server, v 1.1.  
...
__all__ = ['Client', 'ClientEventLog', 'Patient', 'Procedure', 'BinaryResource',
           'SavedProcedure', 'Notification', 'QueueElement' ]
